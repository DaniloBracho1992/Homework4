function initQuiz() {
    //  function to start the count on the timer
        let timeRemaining=0;
    
        
    //  When clicking the button will display the quiz
        ...
        function startQuiz() {
            ...
            let score = 0;
           //  Function to decrease the time by 15 second 
            ...
            let myInterval = setInterval(function() {
                if (timeRemaining<1) {
                    ...
                    // when the timer is done. It will set an atribbute for the final score.
            ...
            function generateQuestion(questionNum) {
                ...
                for (let i=0; i<4; i++) {
                    ...
                    buttonEl.addEventListener("click",function(){
                        //  Function that will decrease the time if the answer incorrect.
                        if (clickTimeout) {
                            return;
                        }
                        clickTimeout = true;
